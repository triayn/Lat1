      ...
      <div class="card card-widget">
        <div class="card-header">
          <div class="user-block">
            ...
            <span class="username"><a href="/dashboard">Jeyano Lathi Sea</a></span>
        ...
        <div class="card-body">
            ...
            <p>I took this photo this morning. What do you think guys?</p>
            <button type="button" class="btn btn-default btn-sm"><i class="fas fa-share"></i> Share</button>
            <button type="button" class="btn btn-default btn-sm"><i class="far fa-thumbs-up"></i> Like</button>
            <span class="float-right text-muted">378 likes - 34 comments</span>
          </div>
          <!-- /.card-body -->
          ...
          <div class="card-footer">
            <form action="#" method="post">
              <img class="img-fluid img-circle img-sm" src="{{ asset('') }}assets/dist/img/user4-128x128.jpg" alt="Alt Text">
